...
(
    ...
    index_id         varchar(100)  null comment '指标要求id',
    proportion_value double        null comment '达成目标值，指标系数之和=1',
    school_grade     varchar(100)  null comment '学生年级(e.g. 2016级)',
    statistic_year   varchar(100)  null comment '统计年份(示例：2014代表2014-2015学年)',
    create_user_id   varchar(100)  null comment '创建人id',
    create_date      datetime      null comment '创建时间',
    modify_user_id   varchar(100)  null comment '修改人id',
    modify_date      datetime      null comment '修改时间',
    status           int default 0 null comment '状态值(-1失效，0默认值代表是导入时的初始设置值，1标识是某课程的计算结果值)'
)
...
(
    ...
    index_number         varchar(100)  null comment '指标要求number',
...
(
    id             varchar(100)              not null comment '主键id'
        primary key,
    index_number   varchar(100)              null comment '指标点要求序号 (4.1/4.2)',
    index_title    varchar(100)              null comment '指标点大项标题',
...
(
    ...
    modify_user_id varchar(100)                        null comment '修改人id',
    modify_date    datetime                            null comment '修改时间',
    status         int(11) unsigned zerofill default 0 null comment '状态值(-1失效，0默认值)'
)
    comment '角色表';
...
(
    id                    varchar(100)                        not null comment '主键'
        primary key,
    user_name             varchar(100)                        null comment '用户名（学号）',
    ...
    start_year            varchar(100)                        null comment '入学年份(即为学生年级)',
